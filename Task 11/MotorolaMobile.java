class MOtorolaMobile
{
   ...
   public static String getModel()
   {
      ...
      System.out.println("Motorola M29");
      return "Motorola M29";
   }
   ...
   public static String getProcessor()
   {
      ...
      System.out.println("Snapdragon 778G");
   ...
   public static String getCameraDetails()
   {
      ...
      System.out.println("50MP Primary Camera");
   ...
   public static String getBatteryDetails()
   {
      ...
      System.out.println("4600mAh Battery");
